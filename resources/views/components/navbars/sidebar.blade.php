...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-2 font-weight-bold text-white">Chatbot Dashboard </span>
        </a>
    </div>
...
{{--            </li>--}}
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'asesores' ? ' active bg-gradient-primary' : '' }} "
                   href="{{ route('asesores') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center"></i>
                    </div>
...
{{--            </li>--}}
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Información de la cuenta</h6>
            </li>
            <li class="nav-item">
